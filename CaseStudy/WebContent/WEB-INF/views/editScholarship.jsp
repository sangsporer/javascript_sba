...
<%@ include file="common/navigation.jspf"%>
	...
	<div class="container col-sm-4 col-sm-offset-4"
		...
		<h2 class="text-center text-primary"> <i class="fas fa-edit"></i> Edit Scholarship</h2>
		<form:form action="editScholarship" method="POST"
			...
			<div class="form-group">
				...
				<form:input type="text" class="form-control" id="detail"
